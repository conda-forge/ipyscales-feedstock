...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/ipyscales-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=5496&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/ipyscales-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `ipyscales` can be installed with:

```
conda install ipyscales
```

It is possible to list all of the versions of `ipyscales` available on your platform with:
